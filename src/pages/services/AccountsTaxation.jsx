  ...
  return (
    <div className="bg-[#f5f8ff] overflow-hidden">
      ...
      <section className="relative overflow-hidden py-20 md:py-32 text-white">
        ...
        {/* Glow */}
        <div className="absolute top-[-120px] left-[-120px] w-[300px] md:w-[450px] h-[300px] md:h-[450px] bg-cyan-400/20 blur-[100px] rounded-full" />
        <div className="absolute bottom-[-120px] right-[-120px] w-[300px] md:w-[450px] h-[300px] md:h-[450px] bg-blue-500/20 blur-[120px] rounded-full" />
        ...
        <div className="relative max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="mt-6 md:mt-8 text-3xl md:text-5xl lg:text-6xl font-black leading-tight">
            Elite Financial
        ...
        <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="mt-8 md:mt-10 grid gap-3 md:gap-4">
              ...
              {features.map((item, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 p-4 rounded-xl md:rounded-2xl bg-white shadow-sm border border-slate-100"
                >
          ...
          >
            ...
            <div className="rounded-2xl md:rounded-[30px] overflow-hidden shadow-xl">
              <img src={img1} alt="Accounts" className="w-full h-56 md:h-[320px] object-cover" />
            </div>

            <div className="rounded-2xl md:rounded-[30px] overflow-hidden shadow-xl">
              <img src={img2} alt="Taxation" className="w-full h-56 md:h-[320px] object-cover" />
            </div>

            {/* Floating badge */}
            <div className="absolute bottom-[-20px] left-4 md:left-10 bg-white/90 backdrop-blur-xl shadow-lg px-4 py-3 rounded-xl text-xs md:text-sm font-bold flex items-center gap-2">
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-5 text-center text-white">
          ...
          <button className="mt-8 md:mt-10 w-full sm:w-auto group relative overflow-hidden px-8 md:px-10 py-4 md:py-5 rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-600 font-bold">
